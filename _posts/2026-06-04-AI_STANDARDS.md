...
13. **Virtuous laziness, not vanity output.** Models don't feel time pressure — you do. Use AI to make the system **simpler and easier to maintain**, not to win lines-of-code scoreboards i swear to god some of yall be geekin. (see [Engineering Rigor & Virtuous Laziness](#engineering-rigor--virtuous-laziness)).
...
Pick a mode first: [sit-and-plan](#planning-pass-lifecycle) or [interplay](#interplay-lifecycle). Planning pass is the default for big or fuzzy work. Interplay relaxes how much you load up front and how long replies can be — **not** spec authority and not guessing behavior. Both modes assume **you** yes **you** twin, supply the intelligence ([Engineering Rigor & Virtuous Laziness](#engineering-rigor--virtuous-laziness)).
...
- You know **what good looks like** before the model runs (spec, direction doc, implementation-plan, code examples).
...
- **Self-review is mandatory** — don't ask a human to review code you haven't read, seriasly.
...
- **Resist LLM dependency to comprehend the system** — if only the model can explain your repo, you don't own it and don't larp like you do. (“gavage geese” — force-fed complexity).
...
- **Lines-of-code per day** as success metric — its beyond dumbasf.
